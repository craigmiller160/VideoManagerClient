...
const ManageVideoFilters = (props) => {
	...
	return (
		<>
					...
					<Row className="mt-3">
						<Col id="category-filters">
							...
							<Row>
								<Col className="text-center">
									<AddButton
										id="category-filters-add-btn"
										addItem={showAddCategoryModal}
									/>
								</Col>
							</Row>
						</Col>
						<Col id="series-filters">
							...
							<Row>
								<Col className="text-center">
									<AddButton
										id="series-filters-add-btn"
										addItem={showAddSeriesModal}
									/>
								</Col>
							</Row>
						</Col>
						<Col id="star-filters">
							...
							<Row>
								<Col className="text-center">
									<AddButton
										id="star-filters-add-btn"
										addItem={showAddStarModal}
									/>
								</Col>
							</Row>
						</Col>
			...
			<FilterInputModal value={selectedFilter} />
		</>
	);
};
...
const ManageVideoFiltersConnected = connect(
	mapStateToProps,
	mapDispatchToProps
)(ManageVideoFilters);
