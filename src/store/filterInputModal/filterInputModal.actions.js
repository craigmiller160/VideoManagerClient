...
const addNewCategoryToEditForm = (newCategory) => (dispatch, getState) => {
	...
	dispatch(
		change(FORM_NAME, 'categories', [...categories, newCategoryFormItem])
	);
};
...
export const showAddCategoryModal = createAction(
	'filterInputModal/showAddCategoryModal'
);
export const showAddSeriesModal = createAction(
	'filterInputModal/showAddSeriesModal'
);
export const showAddStarModal = createAction(
	'filterInputModal/showAddStarModal'
);
export const showEditCategoryModal = createAction(
	'filterInputModal/showEditCategoryModal'
);
export const showEditSeriesModal = createAction(
	'filterInputModal/showEditSeriesModal'
);
export const showEditStarModal = createAction(
	'filterInputModal/showEditStarModal'
);
